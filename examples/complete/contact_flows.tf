...
resource "aws_connect_contact_flow" "test" {
  ...
  "Metadata": {
    ...
    "ActionMetadata": {
      ...
      "da5bb930-05f3-44d2-9b5b-4dcffb8ec62b": {
        ...
        "contactFlow": {
          "text": "GTS-QueueFlow",
          "id": "arn:aws:connect:us-west-2:770688834456:instance/1d16785f-f40f-4f18-b481-8926f1cb4358/contact-flow/3bfea5eb-179d-472d-aff4-702e2e987545"
        },
  ...
  "Actions": [
    ...
    {
      "Parameters": {
        "QueueId": "arn:aws:connect:us-west-2:770688834456:instance/1d16785f-f40f-4f18-b481-8926f1cb4358/queue/58e53512-89b4-477a-9b03-61b5eb18e595"
      },
    ...
    },
    {
      "Parameters": {
        "EventHooks": {
          "CustomerQueue": "arn:aws:connect:us-west-2:770688834456:instance/1d16785f-f40f-4f18-b481-8926f1cb4358/contact-flow/3bfea5eb-179d-472d-aff4-702e2e987545"
        }
      },
  ...
  "Metadata": {
    ...
    "ActionMetadata": {
      ...
      "c68e72e8-c746-4255-afca-b8717e0d142a": {
        ...
        "queue": {
          "id": "$${AWS:Region}:$${AWS:AccountId}:instance/$${ConnectInstanceID}/queue/58e53512-89b4-477a-9b03-61b5eb18e595",
  ...
  "Actions": [
    ...
    },
    {
      "Parameters": {
        ...
        "QueueId": "$${AWS:Region}:$${AWS:AccountId}:instance/$${ConnectInstanceID}/queue/9ab30a46-baeb-43ce-907c-7674efc0db51"
      },
